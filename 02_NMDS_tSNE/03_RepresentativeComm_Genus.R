...
write.table(df, file=sprintf('%s/NMDS_Relative_Representative_Genus.txt', dir$tabledir), sep='\t', quote=F, row.names=F)
...
sel <- c("S_4024", "S_1021", "S_5127", "S_3052", "S_2111", "S_3041", "S_5041")
...
ggsave(plot=g1, filename=sprintf('%s/NMDS_Relative_Representative_Genus.pdf', dir$figdir), h=3, w=4)
...
ggsave(plot=g2, filename=sprintf('%s/NMDS_Relative_Representative_Genus_legend.pdf', dir$figdir), h=4, w=7)
