...
sink(sprintf('%s/tSNE_Relative_Genus_log.txt', dir$tabledir))
...
ggsave(plot=g1, filename=sprintf('%s/NMDS_Relative_Genus.pdf', dir$figdir), h=5, w=6)
...
ggsave(plot=g2, filename=sprintf('%s/tSNE_Relative_Genus.pdf', dir$figdir), h=5, w=6)
