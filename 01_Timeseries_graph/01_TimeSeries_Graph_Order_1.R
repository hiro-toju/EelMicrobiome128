...
ggsave(plot=plot_grid(plotlist=glist1, nrow=5, byrow=FALSE),
       filename=sprintf('%s/TimeSeriesGraph_Absolute_Order.pdf',
...
ggsave(plot=plot_grid(plotlist=glist1, nrow=5, byrow=FALSE),
       filename=sprintf('%s/TimeSeriesGraph_Relative_Order.pdf',
       dir$figdir), h=11.69, w=8.27)
...
ggsave(plot=ggplot(lf)+
            ...
            filename=sprintf('%s/TimeSeriesGraph_Caption_Order.pdf',
