...
ggsave(plot=plot_grid(plotlist=glist1, nrow=5, byrow=FALSE),
       filename=sprintf('%s/TimeSeriesGraph_Absolute_Genus.pdf',
...
ggsave(plot=plot_grid(plotlist=glist1, nrow=5, byrow=FALSE),
       filename=sprintf('%s/TimeSeriesGraph_Relative_Genus.pdf',
       dir$figdir), h=11.69, w=8.27)
...
ggsave(plot=ggplot(lf)+
            ...
            filename=sprintf('%s/TimeSeriesGraph_Caption_Genus.pdf',
